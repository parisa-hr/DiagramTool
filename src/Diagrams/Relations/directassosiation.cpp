...
DirectAssosiation::DirectAssosiation(BaseItem *startItem, BaseItem *endItem, QGraphicsItem *parent):
...
// QPolygonF  endPolygon = myEndItem->mapToItem(myEndItem, myEndItem->rect());
...
BaseItem * DirectAssosiation::getMyStartItem() const
{
    return myStartItem;
}

BaseItem * DirectAssosiation::getMyEndItem() const
{
    return myEndItem;
}

void  DirectAssosiation::updatePosition()
{
